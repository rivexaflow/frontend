  ...
  return (
    <div className="mx-auto max-w-4xl py-10 px-6">
      <div className="mb-10 border-b border-slate-200 pb-6 dark:border-slate-800">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Admin Security</h1>
        <p className="mt-2 text-slate-500">Update your administrative credentials for platform access.</p>
      </div>
